...
# sum of all transction amount 
# and total number of transaction.
...
# print(df[df['customer_id'] == 'CS1112'])
# print(rfm_table.head(5))
...
rfm_seg['RFM_class'] = rfm_seg['R_quartile'].map(str) + rfm_seg['F_quartile'].map(str) + rfm_seg['M_quartile'].map(str)
# .map(str) to convert into string for concatenate
...
# plt.show()
# The tendency in 3 plots are consistent
...
# print(rfm_seg.head(5)) # We have grouped them earlier based on the monetary value 
